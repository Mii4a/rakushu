...
describe("buildResumeWorkbookFromTemplate", () => {
  it("reuses the template workbook layout and injects current values", () => {
    ...
    expect(text).toContain('<c r="D13" s="38" t="inlineStr"><is><t xml:space="preserve">160-0004');
    expect(text).toContain('<c r="I11" s="1" t="inlineStr"><is><t xml:space="preserve">09012345678</t></is></c>');
    expect(text).toContain('<c r="I13" s="1" t="inlineStr"><is><t xml:space="preserve">yamada@example.com</t></is></c>');
    expect(text).toContain('<c r="K6" s="15" t="inlineStr"><is><t xml:space="preserve">平成28年</t></is></c>');
    expect(text).toContain('<c r="L6" s="16" t="inlineStr"><is><t xml:space="preserve">4月</t></is></c>');
    expect(text).toContain('<c r="M6" s="17" t="inlineStr"><is><t xml:space="preserve">東京都立新宿高等学校 入学</t></is></c>');
