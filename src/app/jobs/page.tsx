      ...
      <div className="dashboard-shell">
        <aside className="dashboard-sidebar">
          <div className="rounded-[28px] border border-rakumo-border bg-white px-5 py-4 shadow-[0_16px_32px_-28px_rgba(45,58,74,0.18)]">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-2 text-sm text-rakumo-ink/65">就活求人管理アプリ</p>
              </div>
            </div>
          </div>
          ...
          <nav className="dashboard-nav">
            ...
            <Link href="/jobs" className="dashboard-nav-item dashboard-nav-item-active">
          ...
          <div className="dashboard-sidebar-note">
            ...
            <p>保存済み求人を見返しながら、選考状況と次のアクションを一緒に整える画面です。</p>
          </div>
