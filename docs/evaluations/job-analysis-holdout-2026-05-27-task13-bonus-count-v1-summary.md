...
- reviewer: taro-bot
- scorecard_path: docs/evaluations/job-analysis-holdout-2026-05-27-task13-bonus-count-v1-scorecard.csv
- notes_path: docs/evaluations/job-analysis-holdout-2026-05-27-task13-bonus-count-v1-notes.md
...
- bonusCount present_but_missed: 1
- bonusCount wrong: 0
...
- most common failure class: `summary_line_only_extraction` (1 / 50)
...
- feedback evidence split:
  - observed saved-job subset: 3/3 (100%)
  - simulated public subset: 1/12 (8%)
  - current simulated all-row recall: 1/15 (7%)

## Regression safety
- high-signal fixtures from feedback: 38 current anonymized fixture texts in `fixtures/jobs/`
