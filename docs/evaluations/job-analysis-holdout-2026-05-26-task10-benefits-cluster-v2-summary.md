...
- reviewer: taro-bot
- scorecard_path: docs/evaluations/job-analysis-holdout-2026-05-26-task10-benefits-cluster-v2-scorecard.csv
- notes_path: docs/evaluations/job-analysis-holdout-2026-05-26-task10-benefits-cluster-v2-notes.md
...
- most common failure class: `benefits_suspected_but_not_extracted` (3 / 50)
...
- feedback evidence split:
  ...
  - simulated public subset: 5/15 (33%)
  - current simulated all-row recall: 8/21 (38%)

## Regression safety
- high-signal fixtures from feedback: 31 current anonymized fixture texts in `fixtures/jobs/`
...
- holdout-candidate-037: company_careers | benefits_suspected_but_not_extracted
