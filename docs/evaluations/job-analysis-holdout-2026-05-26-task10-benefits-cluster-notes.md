...
- ./node_modules/.bin/dotenv -e .env.local -- ./node_modules/.bin/tsx scripts/rescore-job-analysis-holdout.ts --seed docs/evaluations/job-analysis-holdout-2026-05-25-task7-retirement-fix-scorecard.csv --output-prefix docs/evaluations/job-analysis-holdout-2026-05-26-task10-benefits-cluster --review-date 2026-05-26 --reviewer taro-bot --observed-feedback-source db
