...
- reviewer: taro-bot
- scorecard_path: docs/evaluations/job-analysis-holdout-2026-05-27-task16-expectation-fix-scorecard.csv
- notes_path: docs/evaluations/job-analysis-holdout-2026-05-27-task16-expectation-fix-notes.md
...
- scope_note: 50 approved holdout raw texts re-parsed with current parser v1.6.1; rows with historical analysis_id keep observed feedback_saved from current shouldCreateFeedback simulation while public-holdout rows use current shouldCreateFeedback simulation
...
- feedback evidence split:
  ...
  - simulated public subset: 0/11 (0%)
  - current simulated all-row recall: 0/14 (0%)

## Regression safety
- high-signal fixtures from feedback: 39 current anonymized fixture texts in `fixtures/jobs/`
