...
- npx --yes tsx scripts/rescore-job-analysis-holdout.ts --seed docs/evaluations/job-analysis-holdout-2026-05-22-signoff-scorecard.csv --output-prefix docs/evaluations/job-analysis-holdout-2026-05-23-track2-check --review-date 2026-05-23 --reviewer taro-bot
