...
- reviewer: taro-bot
- scorecard_path: docs/evaluations/job-analysis-holdout-2026-05-24-task6-after-backfill-scorecard.csv
- notes_path: docs/evaluations/job-analysis-holdout-2026-05-24-task6-after-backfill-notes.md
...
- feedback evidence split:
  - observed saved-job subset: 9/9 (100%)
  - simulated public subset: 22/30 (73%)
  - current simulated all-row recall: 29/39 (74%)
