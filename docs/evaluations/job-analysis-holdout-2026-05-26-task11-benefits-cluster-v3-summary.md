...
- reviewer: taro-bot
- scorecard_path: docs/evaluations/job-analysis-holdout-2026-05-26-task11-benefits-cluster-v3-scorecard.csv
- notes_path: docs/evaluations/job-analysis-holdout-2026-05-26-task11-benefits-cluster-v3-notes.md
...
- most common failure class: `negative_base_salary_detected` (2 / 50)
...
- feedback evidence split:
  ...
  - current simulated all-row recall: 5/19 (26%)

## Regression safety
- high-signal fixtures from feedback: 34 current anonymized fixture texts in `fixtures/jobs/`
