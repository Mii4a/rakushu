...
## Method
- seed manifest: docs/evaluations/job-analysis-holdout-2026-05-22-signoff-scorecard.csv
...
- npx --yes tsx scripts/rescore-job-analysis-holdout.ts --seed docs/evaluations/job-analysis-holdout-2026-05-22-signoff-scorecard.csv --output-prefix docs/evaluations/job-analysis-holdout-2026-05-22-rerun-signoff --review-date 2026-05-22 --reviewer taro-bot
