...
## Method
- seed manifest: docs/evaluations/job-analysis-holdout-2026-05-24-task6-after-backfill-scorecard.csv
...
- simulated public subset: 35 rows
  - feedback_expected: 25
  - feedback_saved (simulated): 17
  - recall (simulated): 68%
...
- ./node_modules/.bin/dotenv -e .env.local -- ./node_modules/.bin/tsx scripts/rescore-job-analysis-holdout.ts --seed docs/evaluations/job-analysis-holdout-2026-05-24-task6-after-backfill-scorecard.csv --output-prefix docs/evaluations/job-analysis-holdout-2026-05-25-task7-retirement-fix --review-date 2026-05-24 --reviewer taro-bot --observed-feedback-source db
