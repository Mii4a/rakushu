...
- simulated public subset: 35 rows
  - feedback_expected: 13
  - feedback_saved (simulated): 2
  - recall (simulated): 15%
...
- ./node_modules/.bin/dotenv -e .env.local -- ./node_modules/.bin/tsx scripts/rescore-job-analysis-holdout.ts --seed docs/evaluations/job-analysis-holdout-2026-05-25-task7-retirement-fix-scorecard.csv --output-prefix docs/evaluations/job-analysis-holdout-2026-05-26-task11-benefits-cluster-v3 --review-date 2026-05-26 --reviewer taro-bot --observed-feedback-source db
