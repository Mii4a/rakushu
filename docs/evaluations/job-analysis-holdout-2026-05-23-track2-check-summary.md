...
- reviewer: taro-bot
- scorecard_path: docs/evaluations/job-analysis-holdout-2026-05-23-track2-check-scorecard.csv
- notes_path: docs/evaluations/job-analysis-holdout-2026-05-23-track2-check-notes.md
...
- same failure type recurring 3+ times in same shape: job_board_listcard:salary_text_without_base_salary=7, job_board_listcard:too_many_unknown_critical_fields=7, noisy_promo:too_many_unknown_critical_fields=6, company_careers:too_many_unknown_critical_fields=6, job_board_detail:salary_text_without_base_salary=5, prose_heavy:too_many_unknown_critical_fields=5, prose_heavy:benefits_suspected_but_not_extracted=3
- high-priority fixture backlog: 24
- most common failure class: `too_many_unknown_critical_fields` (24 / 50)
...
- feedback evidence split:
  ...
  - simulated public subset: 27/33 (82%)
  - current simulated all-row recall: 32/44 (73%)

## Regression safety
- high-signal fixtures from feedback: 15 current anonymized fixture texts in `fixtures/jobs/`
...
- holdout-candidate-019: job_board_listcard | too_many_unknown_critical_fields
...
## Conclusion
- final decision: FAIL
- biggest remaining gap: job_board_listcard:salary_text_without_base_salary recurring 7 times
