...
## Method
- seed manifest: docs/evaluations/job-analysis-holdout-2026-05-24-task5-db-check-scorecard.csv
...
- ./node_modules/.bin/dotenv -e .env.local -- ./node_modules/.bin/tsx scripts/rescore-job-analysis-holdout.ts --seed docs/evaluations/job-analysis-holdout-2026-05-24-task5-db-check-scorecard.csv --output-prefix docs/evaluations/job-analysis-holdout-2026-05-24-task6-after-backfill --review-date 2026-05-24 --reviewer taro-bot --observed-feedback-source db
