...
## Method
- seed manifest: docs/evaluations/job-analysis-holdout-2026-05-24-task1-split-check-scorecard.csv
...
- npx --yes tsx scripts/rescore-job-analysis-holdout.ts --seed docs/evaluations/job-analysis-holdout-2026-05-24-task1-split-check-scorecard.csv --output-prefix docs/evaluations/job-analysis-holdout-2026-05-24-task2-prose-check --review-date 2026-05-24 --reviewer taro-bot
