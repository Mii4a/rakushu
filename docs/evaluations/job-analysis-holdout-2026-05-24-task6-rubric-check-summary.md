...
- reviewer: taro-bot
- scorecard_path: docs/evaluations/job-analysis-holdout-2026-05-24-task6-rubric-check-scorecard.csv
- notes_path: docs/evaluations/job-analysis-holdout-2026-05-24-task6-rubric-check-notes.md
...
- feedback evidence split:
  - observed saved-job subset: 3/9 (33%)
