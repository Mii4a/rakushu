...
- reviewer: taro-bot
- scorecard_path: docs/evaluations/job-analysis-holdout-2026-05-24-task2-prose-check-scorecard.csv
- notes_path: docs/evaluations/job-analysis-holdout-2026-05-24-task2-prose-check-notes.md
...
- same failure type recurring 3+ times in same shape: job_board_detail:salary_text_without_base_salary=5, noisy_promo:too_many_unknown_critical_fields=5, prose_heavy:too_many_unknown_critical_fields=5, company_careers:too_many_unknown_critical_fields=4
...
## Regression safety
- high-signal fixtures from feedback: 25 current anonymized fixture texts in `fixtures/jobs/`
