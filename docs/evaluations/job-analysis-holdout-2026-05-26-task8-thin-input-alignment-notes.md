...
- simulated public subset: 35 rows
  - feedback_expected: 22
  - feedback_saved (simulated): 7
  - recall (simulated): 32%
...
- ./node_modules/.bin/dotenv -e .env.local -- ./node_modules/.bin/tsx scripts/rescore-job-analysis-holdout.ts --seed docs/evaluations/job-analysis-holdout-2026-05-25-task7-retirement-fix-scorecard.csv --output-prefix docs/evaluations/job-analysis-holdout-2026-05-26-task8-thin-input-alignment --review-date 2026-05-26 --reviewer taro-bot --observed-feedback-source db
