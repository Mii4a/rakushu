...
- reviewer: taro-bot
- scorecard_path: docs/evaluations/job-analysis-holdout-2026-05-24-task5-manifest-check-scorecard.csv
- notes_path: docs/evaluations/job-analysis-holdout-2026-05-24-task5-manifest-check-notes.md
...
- same failure type recurring 3+ times in same shape: job_board_detail:retirement_allowance_unknown_with_keyword=8, noisy_promo:too_many_unknown_critical_fields=5, prose_heavy:too_many_unknown_critical_fields=5, company_careers:too_many_unknown_critical_fields=4
...
- feedback evidence split:
  - observed saved-job subset: 3/10 (30%)
  - simulated public subset: 22/30 (73%)
  - current simulated all-row recall: 29/40 (73%)
...
## Conclusion
- final decision: FAIL
- biggest remaining gap: job_board_detail:retirement_allowance_unknown_with_keyword recurring 8 times
