...
## Run metadata
- review_window: 2026-05-22 rerun batch
- reviewer: taro-bot
- scorecard_path: docs/evaluations/job-analysis-holdout-2026-05-22-rerun-signoff-scorecard.csv
- notes_path: docs/evaluations/job-analysis-holdout-2026-05-22-rerun-signoff-notes.md
...
- comparison_usable_yes: 32
- comparison_usable_no: 18
- product gate: fail
...
- same failure type recurring 3+ times in same shape: job_board_listcard:too_many_unknown_critical_fields=8, job_board_listcard:salary_text_without_base_salary=7, noisy_promo:too_many_unknown_critical_fields=6, company_careers:too_many_unknown_critical_fields=6, job_board_detail:salary_text_without_base_salary=5, prose_heavy:too_many_unknown_critical_fields=5, prose_heavy:benefits_suspected_but_not_extracted=3
- high-priority fixture backlog: 25
- most common failure class: `too_many_unknown_critical_fields` (25 / 50)
...
- feedback evidence split:
  ...
  - simulated public subset: 28/33 (85%)
  - current simulated all-row recall: 33/44 (75%)

## Regression safety
- high-signal fixtures from feedback: 13 current anonymized fixture texts in `fixtures/jobs/`
...
- holdout-candidate-017: job_board_listcard | too_many_unknown_critical_fields
- holdout-candidate-018: job_board_listcard | too_many_unknown_critical_fields
...
## Conclusion
- final decision: FAIL
- biggest remaining gap: job_board_listcard:too_many_unknown_critical_fields recurring 8 times
