...
- reviewer: taro-bot
- scorecard_path: docs/evaluations/job-analysis-holdout-2026-05-24-rerun-signoff-scorecard.csv
- notes_path: docs/evaluations/job-analysis-holdout-2026-05-24-rerun-signoff-notes.md
...
- feedback evidence split:
  - observed saved-job subset: 2/4 (50%)
