...
- reviewer: taro-bot
- scorecard_path: docs/evaluations/job-analysis-holdout-2026-05-26-task8-thin-input-alignment-v2-scorecard.csv
- notes_path: docs/evaluations/job-analysis-holdout-2026-05-26-task8-thin-input-alignment-v2-notes.md
...
- feedback evidence split:
  ...
  - simulated public subset: 7/15 (47%)
  - current simulated all-row recall: 10/21 (48%)
