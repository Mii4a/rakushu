...
- reviewer: taro-bot
- scorecard_path: docs/evaluations/job-analysis-holdout-2026-05-29-task16-postfix-scorecard.csv
- notes_path: docs/evaluations/job-analysis-holdout-2026-05-29-task16-postfix-notes.md
...
- feedback evidence split:
  - observed saved-job subset: 2/2 (100%)
  - simulated public subset: 0/0 (0%)
  - current simulated all-row recall: 0/2 (0%)

## Regression safety
- high-signal fixtures from feedback: 40 current anonymized fixture texts in `fixtures/jobs/`
