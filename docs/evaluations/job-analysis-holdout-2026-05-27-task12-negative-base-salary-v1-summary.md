...
## Run metadata
- review_window: 2026-05-27 rerun batch
- reviewer: taro-bot
- scorecard_path: docs/evaluations/job-analysis-holdout-2026-05-27-task12-negative-base-salary-v1-scorecard.csv
- notes_path: docs/evaluations/job-analysis-holdout-2026-05-27-task12-negative-base-salary-v1-notes.md
...
- scope_note: 50 approved holdout raw texts re-parsed with current parser v1.6.1; rows with historical analysis_id keep observed feedback_saved from seed manifest while public-holdout rows use current shouldCreateFeedback simulation
...
- most common failure class: `bonus_count_unknown_with_keyword` (2 / 50)
...
- feedback evidence split:
  - observed saved-job subset: 4/4 (100%)
  - simulated public subset: 2/13 (15%)
  - current simulated all-row recall: 3/17 (18%)

## Regression safety
- high-signal fixtures from feedback: 36 current anonymized fixture texts in `fixtures/jobs/`
