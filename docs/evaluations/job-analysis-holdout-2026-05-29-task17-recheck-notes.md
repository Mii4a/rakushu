...
- ./node_modules/.bin/dotenv -e .env.local -- ./node_modules/.bin/tsx scripts/rescore-job-analysis-holdout.ts --seed docs/evaluations/job-analysis-holdout-2026-05-27-task14-summary-line-only-v1-scorecard.csv --output-prefix docs/evaluations/job-analysis-holdout-2026-05-29-task17-recheck --review-date 2026-05-29 --reviewer taro-bot --observed-feedback-source db
